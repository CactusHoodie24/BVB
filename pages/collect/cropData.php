...
<ul>
    ...
    <div class="main-content">
      ...
      <h1 class="man">Submit Yield Data<h1>
    <form id="weatherForm">
    ...
    <form action="cropData inc.php"  method="post" enctype="multipart/form-data" class="form">
        ...
        <div class="input-box">
            ...
            <input type="date" name="harvest_date" placeholder="Enter date" required />
        </div>
...
function fetchWeather() {
    ...
    var apiKey = '3177a14fdee433a796afa7f410c6e58a'; 
    ...
    .then(data => {
        ...
        var temperatureInCelsius = (data.main.temp - 273.15).toFixed(2);
        ...
        document.getElementById('weatherDetails').value = temperatureInCelsius + "°C";
        document.getElementById('rainfallDetails').value = rainfall;
    })
    .catch(error => {
        console.error('Error fetching weather:', error);
        document.getElementById('weatherDetails').value = 'Failed to fetch weather data.';
        document.getElementById('rainfallDetails').value = 'Failed to fetch rainfall data.';
    });
}
